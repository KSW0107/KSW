...
//		System.out.println(val);
		...
		//예외
		Example exam2 = new Exam02();
		Exam exam3 = (Exam) exam2; 
		
		//ClassNotFoundException -> Class 파일 찾지 못할 때
		//실행메소드(main) 못 찾을 때 자주 발생
		
		//ArithmeticExceoption -> 분모가 0일 때
		//double a = 1/0;
		
		//반목문을 종료하지 못하고 무한 루프 등등
		...
		//Java -> file reading -> 경로가 안 맞아서 파일을 못 찾았다
